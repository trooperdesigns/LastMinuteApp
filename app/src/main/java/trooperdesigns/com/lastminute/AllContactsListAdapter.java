...
public class AllContactsListAdapter extends ParseQueryAdapter implements Filterable {

    @SuppressWarnings("unchecked")
    public AllContactsListAdapter(Context context) {
    ...
    public View getItemView(ParseObject object, View v, ViewGroup parent) {
        if (v == null) {
            v = View.inflate(getContext(), R.layout.contacts_row, null);
        }
